    ...
    <div className={classNames("flex bg-blue-400 text-white", className)}>
      <div className="lg:flex lg:items-center lg:gap-2 w-full max-w-[64rem] px-4 py-3 mx-auto">
        <div className="flex justify-between items-center">
          <Link
            href={getPath({ kind: Path.Home })}
            className="flex items-center hover:opacity-75 mr-2"
          >
        ...
        <div
          ...
          ref={linksRef}
        >
          <NavbarLink href={getPath({ kind: Path.ProblemSetList })} className="mt-2 lg:mt-0">
            Problems
          </NavbarLink>
...
export const NavbarAccount = memo(() => {
  ...
  if (session == null || session.user == null) {
    return (
      <>
        <NavbarLink href={getPath({ kind: Path.AccountLogin })} className="lg:ml-auto">
          Login
        </NavbarLink>
