...
const HeroBanner = () => {
  return (
    <div className={classNames(styles.hero, "text-center py-32 px-6")}>
      <h1 className="text-6xl lg:text-9xl font-semibold">Hurado</h1>
      <p className="text-4xl lg:text-5xl mt-4">NOI.PH Online Judge</p>
...
const FeatureItem = ({ Icon, title, children }: FeatureItemProps) => {
  return (
    <div className="flex-1 text-center mb-4">
      ...
      <div className="text-white text-2xl mt-3">{title}</div>
      <div className="text-white text-md font-light mt-1">{children}</div>
    </div>
  );
};
...
const Faqs = () => {
  return (
    <div className="bg-blue-300 px-6 pt-10 pb-6">
      <div className="max-w-[64rem] mx-auto">
        <h2 className="text-white text-4xl font-semibold text-center mb-4">FAQ</h2>
        <div className="">
          <FaqItem>
            <FaqQuestion>
              {/* eslint-disable-next-line react/no-unescaped-entities -- pre-existing error before eslint inclusion */}
            ...
            <FaqAnswer>
              An online judge is a system that allows you to submit programs and have them
              automatically checked for correctness.
            </FaqAnswer>
          </FaqItem>
          <FaqItem>
            <FaqQuestion>Why would anyone want to do this?</FaqQuestion>
            <FaqAnswer>
              {/* eslint-disable-next-line react/no-unescaped-entities -- pre-existing error before eslint inclusion */}
          ...
          <FaqItem>
            ...
            <FaqAnswer>Yes, it is free!</FaqAnswer>
          </FaqItem>
        </div>
      </div>
    </div>
...
const Tutorial = () => {
  return (
    <div className="bg-blue-450 px-6 py-10">
      <div className="max-w-[64rem] mx-auto">
        <h2 className="text-white text-4xl font-semibold text-center mb-4">Tutorial</h2>
        <div className="text-white text-center">
          Completely lost on how to read the problems? Check out this{" "}
          <a href="https://noi.ph/tutorial" target="_blank" className="font-bold hover:opacity-80">
            tutorial
          </a>{" "}
          made by our AlumNOI!
        </div>
...
const Sponsors = () => {
  return (
    <div className="bg-white px-6 pt-10 pb-6">
      <div className="max-w-[64rem] mx-auto">
        <h2 className="text-black text-4xl font-semibold text-center mb-6">Sponsored By</h2>
