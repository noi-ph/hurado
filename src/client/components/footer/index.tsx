    ...
    <footer className="bg-blue-400 text-white p-4 lg:px-12">
      <div className="flex flex-col md:flex-row gap-2 w-full max-w-[64rem] px-4 mx-auto">
        ...
        <div className="text-neutral-800 text-sm font-light self-center w-1/2 text-center mx-auto md:w-1/3 md:text-start md:mx-0 mb-3 md:mb-0">
          <span className="font-semibold">NOI.PH Inc.</span> is an SEC-registered Philippine
          non-profit organization dedicated to elevating computer science education nationwide.
        </div>
        <div className="flex-auto flex flex-col justify-center items-center text-center">
          <a
            href="https://noi.ph/wpautoterms/terms-and-conditions/"
            target="_blank"
          ...
          <a
            href="https://noi.ph/wpautoterms/privacy-policy/"
            target="_blank"
            className="hover:opacity-80"
          >
            Privacy Policy
        ...
        <div className="flex-initial flex justify-center items-center">
          <div className="h-12 w-12 flex justify-center items-center">
            <a
              href="https://facebook.com/noi.philippines"
              target="_blank"
              className="justify-center items-center hover:opacity-80"
            >
          ...
          <div className="h-12 w-12 flex justify-center items-center">
            <a
              href="https://instagram.com/noi.philippines"
              target="_blank"
              className="justify-center items-center hover:opacity-80"
            >
          ...
          <div className="h-12 w-12 flex justify-center items-center">
            <a
              href="https://github.com/noi-ph/hurado"
              target="_blank"
              className="justify-center items-center hover:opacity-80"
            >
