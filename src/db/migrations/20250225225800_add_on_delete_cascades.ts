...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema.alterTable("verdicts").dropConstraint("verdicts_submission_id_fkey").execute();

  await db.schema
    .alterTable("verdicts")
    .addForeignKeyConstraint("verdicts_submission_id_fkey", ["submission_id"], "submissions", [
      "id",
    ])
    .onDelete("cascade")
    .execute();
